...
export default function AdminLayout() {
      ...
      <div className={`flex items-center gap-3 px-5 py-5 border-b border-white/10 shrink-0 ${collapsed ? "justify-center" : ""}`}>
        ...
        {!collapsed && (
          <div>
            ...
            <p className="text-blue-400 text-xs mt-0.5">DevOpsAkademy</p>
          </div>
        )}
      </div>
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      <aside className={`hidden lg:flex flex-col bg-[#0B1526] transition-all duration-300 ${collapsed ? "w-[72px]" : "w-64"} shrink-0 sticky top-0 h-screen z-30`}>
        <SidebarContent />
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <aside className="absolute left-0 top-0 h-full w-64 bg-[#0B1526] flex flex-col">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 pl-3 border-l border-gray-200">
              ...
              <div className="hidden sm:block text-sm">
                ...
                <p className="text-xs text-blue-500 mt-0.5">Administrateur</p>
              </div>
            </div>
          </div>
        </div>
